...
const CHECKS = {
    'phase1': [
        {
            id: 'shell',
            label: 'React Shell (cosmos_app/client/package.json)',
            check: () => checkFileExists('cosmos_app/client/package.json')
        },
        {
            id: 'datalayer',
            label: 'Data Layer (cosmos_app/server/index.js)',
            check: () => checkFileExists('cosmos_app/server/index.js')
        },
        {
            id: 'graphlib',
            label: 'Graph Library Installed',
            check: () => {
                const pkgPath = path.join(ROOT_DIR, 'cosmos_app/client/package.json');
        ...
        },
        {
            ...
            check: () => {
                const appPath = path.join(ROOT_DIR, 'cosmos_app/client/src/App.jsx');
